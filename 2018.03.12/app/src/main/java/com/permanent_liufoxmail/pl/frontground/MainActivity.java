    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    socket = new Socket("192.168.31.236", 10010);
    ...
    private class MyHandler extends Handler
    {
        ...
        public void handleMessage(Message message)
        {
            ...
            if (message.what == 1)
            {
                ...
                {
                    com.permanent_liufoxmail.pl.background.Message content = new com.permanent_liufoxmail.pl.background.Message(split[1], 1, split[2], "我：");
                    list.add(content);
                }
                else
                {
                    com.permanent_liufoxmail.pl.background.Message content = new com.permanent_liufoxmail.pl.background.Message(split[1], 2, split[2], ("来自：" + split[0]));
                    list.add(content);
                }
